// File: src/components/routes/ProtectedReportsRoute.tsx
    ...
    <div className="max-w-5xl mx-auto px-4 py-12">
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-text-muted text-lg md:text-xl max-w-2xl mx-auto leading-relaxed">
          Desbloquea análisis avanzados y visualizaciones inteligentes generadas por IA para optimizar tu negocio
        </p>
      </div>
      ...
      <div className="bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-200 rounded-2xl p-8 mb-8">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h4 className="text-2xl font-bold text-gray-900">
            ¿Qué obtendrás con Reportes AI Premium?
          </h4>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-8">
          <div className="bg-white/80 backdrop-blur rounded-xl p-5 border border-blue-100 hover:border-primary transition-colors">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="font-bold text-gray-900 mb-1">Análisis de Ventas Inteligente</p>
                <p className="text-sm text-gray-600">
                  Visualiza tus productos más vendidos con gráficas interactivas y rankings automáticos generados por IA
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white/80 backdrop-blur rounded-xl p-5 border border-blue-100 hover:border-primary transition-colors">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="font-bold text-gray-900 mb-1">Distribución de Ingresos</p>
                <p className="text-sm text-gray-600">
                  Comprende qué productos generan más ingresos con gráficas circulares y análisis de participación
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white/80 backdrop-blur rounded-xl p-5 border border-blue-100 hover:border-primary transition-colors">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="font-bold text-gray-900 mb-1">Productos Destacados y Oportunidades</p>
                <p className="text-sm text-gray-600">
                  Identifica automáticamente tus productos estrella y aquellos con potencial de mejora
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white/80 backdrop-blur rounded-xl p-5 border border-blue-100 hover:border-primary transition-colors">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="font-bold text-gray-900 mb-1">KPIs y Métricas Clave</p>
                <p className="text-sm text-gray-600">
                  Monitorea ingresos totales, unidades vendidas y ticket promedio con visualizaciones profesionales
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white rounded-xl p-6 border border-gray-200">
          ...
          <div className="grid md:grid-cols-2 gap-3">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm text-gray-700">Top 5 productos por ventas con gráficas</span>
            </div>
            <div className="flex items-center gap-2">
              <CheckCircleIcon className="w-5 h-5 text-green-500 flex-shrink-0" />
              <span className="text-sm text-gray-700">Top 10 productos por ingresos</span>
            </div>
            <div className="flex items-center gap-2">
              <CheckCircleIcon className="w-5 h-5 text-green-500 flex-shrink-0" />
              <span className="text-sm text-gray-700">Gráficas circulares de distribución</span>
            </div>
            <div className="flex items-center gap-2">
              <CheckCircleIcon className="w-5 h-5 text-green-500 flex-shrink-0" />
              <span className="text-sm text-gray-700">Dashboard inteligente con IA</span>
            </div>
            <div className="flex items-center gap-2">
              <CheckCircleIcon className="w-5 h-5 text-green-500 flex-shrink-0" />
              <span className="text-sm text-gray-700">Análisis de productos de baja rotación</span>
            </div>
            <div className="flex items-center gap-2">
              <CheckCircleIcon className="w-5 h-5 text-green-500 flex-shrink-0" />
              <span className="text-sm text-gray-700">Exportación de reportes</span>
            </div>
          </div>
        </div>
      </div>
...
const ProtectedReportsRoute = ({ children }: ProtectedReportsRouteProps) => {
  ...
  useEffect(() => {
    const checkAccess = async () => {
      try {
        console.log('🚀 Verificando acceso a Reportes AI desde API...');
        ...
        console.log('📦 Respuesta de suscripción (Reportes):', result);
        ...
        console.log('📋 Plan (Reportes):', plan);
        console.log('📋 Status (Reportes):', status);
        ...
        console.log('✅ isPremium (Reportes):', isPremium);
        console.log('✅ isActive (Reportes):', isActive);
        console.log('🎯 ACCESO FINAL A REPORTES AI:', hasAccess);
        
        setHasAccess(hasAccess);
        
      } catch (error) {
        console.error('❌ Error al verificar acceso a Reportes AI:', error);
        setHasAccess(false);
      } finally {
        setIsLoading(false);
      }
