// File: src/components/routes/ProtectedRecommendationsRoute.tsx
...
interface ProtectedRecommendationsRouteProps {
    ...
    <div className="max-w-5xl mx-auto px-4 py-12">
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-text-muted text-lg md:text-xl max-w-2xl mx-auto leading-relaxed">
          Desbloquea el poder de la inteligencia artificial para impulsar tu negocio con insights y análisis predictivos
        </p>
      </div>
      ...
      <div className="bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-200 rounded-2xl p-8 mb-8">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h4 className="text-2xl font-bold text-gray-900">
            ¿Qué obtendrás con los Beneficios de la IA?
          </h4>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-8">
          <div className="bg-white/80 backdrop-blur rounded-xl p-5 border border-blue-100 hover:border-primary transition-colors">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="font-bold text-gray-900 mb-1">Productos Destacados</p>
                <p className="text-sm text-gray-600">
                  Identifica automáticamente qué productos tienen mejor desempeño y recibe análisis detallados sobre por qué funcionan tan bien
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white/80 backdrop-blur rounded-xl p-5 border border-blue-100 hover:border-primary transition-colors">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="font-bold text-gray-900 mb-1">Oportunidades de Mejora</p>
                <p className="text-sm text-gray-600">
                  Recibe recomendaciones concretas y accionables para mejorar el rendimiento de productos con bajo desempeño
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white/80 backdrop-blur rounded-xl p-5 border border-blue-100 hover:border-primary transition-colors">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="font-bold text-gray-900 mb-1">Comparativas Globales</p>
                <p className="text-sm text-gray-600">
                  Compara tu desempeño con el promedio de todas las tiendas en la plataforma y descubre áreas de oportunidad
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white/80 backdrop-blur rounded-xl p-5 border border-blue-100 hover:border-primary transition-colors">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="font-bold text-gray-900 mb-1">Resumen Ejecutivo</p>
                <p className="text-sm text-gray-600">
                  Obtén insights clave presentados de forma clara y visual para tomar mejores decisiones estratégicas de negocio
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white rounded-xl p-6 border border-gray-200">
          ...
          <div className="grid md:grid-cols-2 gap-3">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm text-gray-700">Recomendaciones IA personalizadas</span>
            </div>
            <div className="flex items-center gap-2">
              <CheckCircleIcon className="w-5 h-5 text-green-500 flex-shrink-0" />
              <span className="text-sm text-gray-700">Análisis predictivo de ventas</span>
            </div>
            <div className="flex items-center gap-2">
              <CheckCircleIcon className="w-5 h-5 text-green-500 flex-shrink-0" />
              <span className="text-sm text-gray-700">Optimización de inventario</span>
            </div>
            <div className="flex items-center gap-2">
              <CheckCircleIcon className="w-5 h-5 text-green-500 flex-shrink-0" />
...
const ProtectedRecommendationsRoute = ({ children }: ProtectedRecommendationsRouteProps) => {
  ...
  useEffect(() => {
    const checkAccess = async () => {
      try {
        console.log('🚀 Verificando acceso en Protected Route desde API...');
        ...
        console.log('📦 Respuesta de suscripción (Protected):', result);
        ...
        console.log('📋 Plan (Protected):', plan);
        ...
        console.log('✅ isPremium (Protected):', isPremium);
        console.log('✅ isActive (Protected):', isActive);
        console.log('🎯 ACCESO FINAL (Protected):', hasAccess);
        
        setHasAccess(hasAccess);
        
      } catch (error) {
        console.error('❌ Error al verificar acceso en Protected Route:', error);
        setHasAccess(false);
      } finally {
        setIsLoading(false);
      }
...
export default ProtectedRecommendationsRoute;